...
* [27/39] snvecR is /published/ on CRAN, github, zenodo       :prj:
:PROPERTIES:
:CREATED:  [2023-04-04 Tue 09:27]
:END:
...
** [13/17] write tests for each component                   :prj:
*** DONE test qinterp
...
*** NEXT [8/11] write test for snvec itself
:PROPERTIES:
:CREATED:  [2023-04-06 Thu 16:38]
:END:
**** [7/9] returns errors with wrong inputs?
:LOGBOOK:
