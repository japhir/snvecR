---
title: "Analyze a grid of T<sub>d</sub> and E<sub>d</sub> values"
...
options(rmarkdown.html_vignette.check_title = FALSE) # we have intentionally differing ones to enable the subscript
```
...
biggrid <- biggrid |>
  ...
  mutate(file = cli::format_inline("{tempdir()}/2023-04-13_biggrid_{Td}_{Ed}_{tol}_{tend}.rds"))
biggrid
```
...
biggrid |>
  ...
  # arguments
  rename(td = Td, ed = Ed, tolerance = tol) |>
