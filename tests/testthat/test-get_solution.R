...
test_that("get_solution() works", {
  ...
  expect_snapshot(get_solution(astronomical_solution = "PT-ZB18a", quiet = TRUE) |> head())
  expect_snapshot(get_solution(astronomical_solution = "PT-ZB18a", quiet = FALSE, force = TRUE) |> head(),
